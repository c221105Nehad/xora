...
const Download = () => {
  return (
    <section>
      <Element
        name="download"
        className="g7 relative pb-32 max-lg:pb-24 max-md:py-16"
      >
            ...
            <div className="mb-10 max-md:hidden">
              <div className="download_preview-before download_preview-after rounded-40 relative w-[955px] border-2 border-s5 p-6">
                <div className="relative rounded-3xl bg-s1 px-6 pb-6 py-14">
                  ...
                  <span className="download_preview-dot left-6 bg-s3"></span>
                  <span className="download_preview-dot left-6 bg-p1/15"></span>
